...
export default async function DettaglioPraticaPage({
    ...
    const getStatoBadge = (stato: string) => {
        ...
        return badges[stato] || badges.DA_ELABORARE;
    };
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <p className="mt-2 text-gray-600">
                                Creata il {new Date(pratica.dataRichiesta).toLocaleDateString("it-IT")} da {pratica.operatore}
                            </p>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="flex items-center gap-2 text-gray-900">
                                            ...
                                            {pratica.dataPartenza
                                                ? new Date(pratica.dataPartenza).toLocaleDateString("it-IT")
                                                : "N/A"}
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <p className="flex items-center gap-2 text-gray-900">
                                            <Calendar className="h-4 w-4 text-gray-400" />
                                            {pratica.dataRitorno
                                                ? new Date(pratica.dataRitorno).toLocaleDateString("it-IT")
                                                : "N/A"}
                                        </p>
                                    </div>
                                </div>
